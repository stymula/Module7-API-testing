...
public class UpdateBoardTest extends BaseTest{
    ...
    public void update_board(){
        ...
        AllureLogger.info("Starting the test to update BOARD");
        ...
        AllureLogger.info("New Board Id created is : " +IDtoUpdate);
        ...
        AllureLogger.info("Sending the PUT request to update Board details of Board id : " + IDtoUpdate);
