...
public class CreateBoardTest extends BaseTest{
    ...
    public void create_board_with_name_and_description() {
        AllureLogger.info("Starting the test to create new BOARD");
        ...
        AllureLogger.info("Sending the POST request to create new BOARD");
        Response response = postRequest(boardDetails);

        AllureLogger.info("Asserting if the response's status code returned is 200");
        ...
        AllureLogger.info("Retrieved board id: " + newId);
    }
}
